...
const posts = [
  {
    ...
    content: "Learn the basics of React Native here.",
  },
  {
    id: 2,
    title: "Expo Router Setup",
    content: "How to setup navigation using Expo Router.",
  },
  {
    id: 3,
    title: "Search Component",
    content: "Build a search component using React and state.",
  },
];
...
function Search() {
  ...
  return (
    ...
    >
      ...
      <ThemedText style={{ marginTop: 10 }}>Stay tuned for updates.</ThemedText>
    </ThemedView>
  );
}
